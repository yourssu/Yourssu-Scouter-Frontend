...
import {
    ...
    StyledBodyContainer,
    StyledFieldList, StyledIconButton, StyledFieldContainer, StyledOptionContent
} from "@/components/ApplicationDialog/ApplicationDialog.style.ts";
import {
    BoxButton,
    IcCloseLine, IcCopyLine,
    IcMenuLine,
    IcPlusLine, IcTrashLine, TextButton,
    TextField
        ...
        <Popover.Root>
            ...
            <Popover.Portal>
                <StyledContent sideOffset={6} align="end">
                        ...
                        <StyledFieldList>
                            {
                                selectedParts.map(part => (
                                    <StyledFieldContainer key={part.partId}>
                                        <TextField placeholder={`[${semester.semester}] 유어슈 ${part.partName} 지원서 URL`}>
                    ...
                    <StyledBottomContainer>
                        <BoxButton onClick={() => postApplicantsFromFormMutation.mutate()} variant="filledPrimary"
                                   size="large">
                            저장하고 불러오기
                        </BoxButton>
                    </StyledBottomContainer>
