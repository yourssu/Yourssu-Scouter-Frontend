...
import { CurrentTimeIndicator } from '@/pages/NewInterview/components/WeeklyCalendar/CurrentTimeIndicator';
import { WeeklyScheduleItem } from '@/pages/NewInterview/components/WeeklyCalendar/WeeklyScheduleItem';
import { WeeklyCalendarLayout } from '@/pages/NewInterview/components/WeeklyCalendarLayout';
import { hourHeight, startHour } from '@/pages/NewInterview/components/WeeklyCalendarLayout/type';
...
// 두 일정이 시간적으로 겹치는지 확인
const isOverlapping = (a: Schedule, b: Schedule): boolean => {
  return a.startTime < b.endTime && a.endTime > b.startTime;
};

// 겹치는 일정들의 레이아웃 정보를 계산
const calculateOverlapLayout = (schedules: Schedule[]): Map<number, OverlapInfo> => {
...
const WeeklyScheduleItemPosition = ({
  ...
  overlapInfo,
  children,
}: React.PropsWithChildren<{ overlapInfo?: OverlapInfo; schedule: Schedule }>) => {
