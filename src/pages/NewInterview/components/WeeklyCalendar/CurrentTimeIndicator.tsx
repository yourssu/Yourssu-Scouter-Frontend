...
export const CurrentTimeIndicator = () => {
  ...
  return (
    ...
    >
      <div className="absolute top-0 h-[2px] w-full -translate-y-1/2 bg-[#5b4dff]" />
      <div className="absolute top-0 -left-[60px] flex w-[60px] -translate-y-1/2 justify-end">
        <span className="rounded bg-[#5b4dff] px-2 py-0.5 text-xs text-white">
          {formatTemplates['23:59'](now)}
        </span>
      </div>
    </div>
  );
